...
fwrite(trees_merge,"H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_trees_merge.csv")


data1 <- trees_merge
data2 <-  fread("H:/Shared drives/Growth & Yield Lab/Data Sets/PGYI/2023-09-08 PGYI Export/trees_measurement.csv")

# trees_merge has 38 variables while original file has 30:tree_label, tree_location, tree_origin, sector_or_quarter, species, distance, azimuth, trees_comment
