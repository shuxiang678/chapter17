...
fwrite(plot,"H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_plot.csv")


# compare output file with original compilation code
data1 <- read.csv("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_plot.csv")
data2 <- read.csv("H:/Shared drives/Growth & Yield Lab/Data Sets/PGYI/2023-09-08 PGYI Export/plot.csv")

# Check if there are any differences
differences1 <- anti_join(data1, data2)
differences2 <- anti_join(data2, data1)

# sampling_unit_number contains "0" which are "blank" in original file